...
export default function ProductCard({Product, id}) {
    return(
        <div className="w-full flex flex-col space-y-2 text-gray-700 border rounded-t-2xl rounded-b-md p-2 shadow">
            <div>
            ...
            <button className="bg-amber-200 py-1 rounded-md text-gray-700 font-semibold hover:bg-amber-100 text-[0.9rem]">Ajouter au Panier</button>
        </div>
    )
}
